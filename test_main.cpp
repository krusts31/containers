 ...
 */
	...
	for (int CONSTRUCTOR = def; CONSTRUCTOR <= copy;  CONSTRUCTOR++)
	{
		...
		mini_test_func_4<int>(size_of_vec, at, "at(" + std::to_string(size) + ")", CONSTRUCTOR, size);
		mini_test_func_4<float>(size_of_vec, at, "at(" + std::to_string(size) + ")", CONSTRUCTOR, size);
		mini_test_func_4<double>(size_of_vec, at, "at(" + std::to_string(size) + ")", CONSTRUCTOR, size);
		mini_test_func_4<std::string>(size_of_vec, at, "at(" + std::to_string(size) + ")", CONSTRUCTOR, size);
		mini_test_func_4<char>(size_of_vec, at, "at(" + std::to_string(size) + ")", CONSTRUCTOR, size); 
		mini_test_func_4<char **>(size_of_vec, at, "at(" + std::to_string(size) + ")" , CONSTRUCTOR, size);
	}
